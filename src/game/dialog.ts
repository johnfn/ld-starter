...
export class DialogBox extends Entity {
  ...
  constructor() {
    ...
    this.speakerText = new TextEntity({ text: "Name test", width: 900, height: 400, fontSize: 40});
    this.speakerText.y = 30;
    this.speakerText.x = 90;

    this.addChild(this.speakerText);

    this.dialogText = new TextEntity({ text: "Line test", width: 900, height: 400, fontSize: 30});
