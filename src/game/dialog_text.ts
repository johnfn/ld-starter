...
export class DialogTexts {
  public static IntroText: DialogText = [
    ...
    { speaker: "Chief Oberon Nabisco", text : "Look. Your words. Not mine. ", },
    ...
    { speaker: "Chief Oberon Nabisco", text : "Fine. This house. It’s empty. Owners died last month. But. The executioner of their will. He filed a report. There’s something missing. An antique mirror. Diamond-studded. Worth maybe $5000. It’s gone. Burglary suspected. Now you two are there. Look for clues. Solve the mystery.", },
    { speaker: "Detective Pringle", text : "Cool, cool. Thanks for the call to action, bud.", },
    { speaker: "Chief Oberon Nabisco", text : "Stop doing that.", },
