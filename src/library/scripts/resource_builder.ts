...
`
  ...
  for (const fileName of allFiles) {
    ...
    if (fileName.endsWith(".png") || fileName.endsWith(".gif")) {
      ...
      if (isPathTiledTileMap(path.join(assetDirectory, fileName))) {
        resourceType = "ResourceType.TileMap";
      } else if (isPathTiledWorldMap(path.join(assetDirectory, fileName))) {
        resourceType = "ResourceType.TileWorld";
      } else {
        continue;
      }
